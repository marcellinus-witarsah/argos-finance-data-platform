...
class TestAPIExtractor(TestCase):
    ...
    def test_api_extractor_returns_dict_data_type_on_success(self):
        ...
        data = APIExtractor.extract(self.mock_session, self.mock_url, self.mock_query_params, self.mock_headers)
    ...
    def test_api_extractor_raise_http_error_on_failed(self):
        ...
        with self.assertRaises(requests.exceptions.HTTPError):
            APIExtractor.extract(self.mock_session, self.mock_url, self.mock_query_params, self.mock_headers)