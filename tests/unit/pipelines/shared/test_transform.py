...
class TestTransform:
    def test_add_md5_hash(self, spark):
        ...
        df = df.transform(add_md5_hash, col="json_data", target_col="md5_hash_value")
    ...
    def test_parse_json(self, spark):
        ...
        df = df.transform(
            ...
            target_col="parsed_json_data",
        )

        chispa.assert_column_equality(df, "parsed_json_data", "expected_parsed_json")
    ...
    def test_add_load_dttm(self, spark, mocker):
        ...
        df = df.transform(add_load_dttm, target_col="load_dttm")
    ...
    def test_add_load_prdt(self, spark):
        ...
        df = df.transform(add_load_prdt, col="load_dttm", target_col="load_prdt")
