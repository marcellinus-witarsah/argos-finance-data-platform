...
envsubst < /tmp/conf/core-site.xml.template > /root/gravitino/conf/core-site.xml
envsubst < /tmp/conf/core-site.xml.template > /root/gravitino/iceberg-rest-server/conf/core-site.xml
