...
download_and_verify_jar_file "${ICEBERG_SPARK_RUNTIME_JAR}" "${ICEBERG_SPARK_RUNTIME_MD5}" ${target_dir}
...
download_and_verify_jar_file "${HADOOP_AWS_JAR}" "${HADOOP_AWS_MD5}" ${target_dir}
...
download_and_verify_jar_file "${AWS_JAVA_SDK_BUNDLE_JAR}" "${AWS_JAVA_SDK_BUNDLE_MD5}" ${target_dir}