...
class TestDataframeExtractor(TestCase):
    ...
    def test_extract_function_reads_correct_table(self):
        DataframeExtractor.extract(self.mock_spark, self.mock_catalog, self.mock_schema, self.mock_table)
    ...
    def test_function_return_spark_dataframe_type_on_success(self):
        ...
        df = DataframeExtractor.extract(self.mock_spark, self.mock_catalog, self.mock_schema, self.mock_table)
